...
| Item | Where | Status |
|---|---|---|
| Verified pool transactions | `strk20.json` | **34 recorded, 34 SUCCEEDED, 17 through our own contracts** (27 by the organisers' looser pool-event rule). `pnpm verify` re-checks every one against both rules |
